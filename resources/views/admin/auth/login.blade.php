...
<html lang="ar">
  ...
  <body>
                ...
                <div class="hidden w-full xl:block xl:w-1/2">
                  <div class="px-26 py-17.5 text-center">
                    <a class="mb-5.5 inline-block" href="index.html">
                      ...
                      <img
                        class="dark:hidden"
                        src="{{URL::asset('assets/src/images/logo/logo-dark.svg')}}"
                        alt="Logo"
                      />
                    </a>
                    ...
                    <span class="mt-15 inline-block">
                      <img
                        src="{{URL::asset('assets/src/images/illustration/illustration-03.svg')}}"
                        alt="illustration"
                      />
                    </span>
                  </div>
    ...
    <!-- ===== Page Wrapper End ===== -->
  <script defer src="{{URL::asset('assets/src/bundle.js')}}"></script></body>
</html>
