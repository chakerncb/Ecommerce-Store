    ...
    >
      ...
      <div>
          ...
          <li>
            ...
            <li>
              <a
                ...
                :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Products') || (page === 'Products List' || page === 'Add New') }"
              >
        ...
        <li>
          ...
          >
          <svg xmlns="http://www.w3.org/2000/svg" width="23px" height="25px" viewBox="0 0 1024 1024" fill="#ffffff" class="icon" version="1.1">
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="#"
              @click.prevent="selected = (selected === 'Categorys' ? '':'Categorys')"
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Categorys') || (page === 'Category List' || page === 'Add New Category') }"
            >
            <svg width="27px" hight="27px"  viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#8A909C" stroke="#ffffff00">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier"> <title>category-list-solid</title>
              ...
              <svg
              class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
              :class="{ 'rotate-180': (selected === 'Categorys') }"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
            ...
            <div
              class="translate transform overflow-hidden"
              :class="(selected === 'Categorys') ? 'block' :'hidden'"
            >
              <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
              <li>
                <a
